...
```
  ...
  * I've been working in [@neurotransmitiendo](https://www.neurotransmitiendo.org/) to be one of the biggest neuroscience dissemination project in Argentina.

```
Since 2020: Digital Marketing Supervisor @neurotransmitiendo
```
  * [Neurotransmitiendo](https://www.neurotransmitiendo.org/)
  * I've been working in [@neurotransmitiendo](https://www.neurotransmitiendo.org/) to create newsletters about Neuroscience and Psychology.

```
Since 2021: Events Supervisor @neurotransmitiendo
```
  * [Neurotransmitiendo](https://www.neurotransmitiendo.org/)
  * I've been working in [@neurotransmitiendo](https://www.neurotransmitiendo.org/) to be create and organize different events like talks and workshops.
...
I never felt satisfied with all the topics that I've been learning in my Degree, so I decided to take 
advantage of extra academic formation from several resources: from subjects of other universities,
to great online courses.
```
